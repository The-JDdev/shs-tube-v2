...
public final class ActivityPlayerBinding implements ViewBinding {
  ...
  private ActivityPlayerBinding(@NonNull FrameLayout rootView, @NonNull PlayerView playerView) {
  ...
  public static ActivityPlayerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityPlayerBinding((FrameLayout) rootView, playerView);
    }
